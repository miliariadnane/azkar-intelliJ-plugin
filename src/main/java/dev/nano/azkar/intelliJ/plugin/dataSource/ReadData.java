...
public class ReadData {
    ...
    public static ImmutableList<Zikr> getAzkarFromJson() throws IOException {
        InputStream inputStream = ReadData.class.getClassLoader().getResourceAsStream("azkar.json");
        //InputStream inputStream = Resources.getResource("data/azkar.json").openStream();
